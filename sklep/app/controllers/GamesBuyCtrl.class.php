...
use core\Utils;
use core\ParamUtils;
use app\forms\GamesBuyForm;

/**
 * Kontoler kupowania gry built in Amelia
 *
...
class GamesBuyCtrl {
    ...
    public function action_gamesBuy() {
        $this->load_data();
        // 4. wygeneruj widok
        App::getSmarty()->assign('buyForm', $this->form); // dane formularza (kupowania w tym wypadku)
        App::getSmarty()->assign('games', $this->records);  // lista rekordów z bazy danych
        App::getSmarty()->display("GamesBuy.tpl");
    }
}